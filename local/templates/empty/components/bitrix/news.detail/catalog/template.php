...
<!--							</a>-->
							<a href="/catalog/rent/index.php" class="d-flex flex-column flex-sm-row
							align-items-center justify-content-center justify-content-sm-start product--info-link" target="_blank">
